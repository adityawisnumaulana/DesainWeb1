...
<html>
<head>
  <title>Toko Buff MS</title>
  <link rel="stylesheet" type="text/css" href="plugin/bootstrap/css/bootstrap.min.css">
  <link rel="stylesheet" type="text/css" href="assett/css/main.css">
  <link rel="icon" type="image/gif/png" href="assett/img/Title.png">
</head>
<body>
...
<div class="container-fluid" id="isi" >
  ...
  <div class="row">
    <div class="col-xs-2 col-xs-offset-5" id="produk-laris">
      <h3 style="font-family: Blacksword; font-size:2.2em;"><strong>Produk Buff</strong></h3>
    </div>
  </div>
...
<script type="text/javascript" src="assett/js/script.js"></script>
</body>
</html>